...
// `demo` is a persistent sandbox scholar (see scholars-data.js) for previewing
// this screen from the scholar side. Kept on purpose — see the DEMO block in
// scholars-data.js before removing it.
